      ...
      <body className={`${rubik.className} antialiased`}>
        ...
        <span
          ...
          dangerouslySetInnerHTML={{
            __html: `<!--
THESIS: A mother rests in a cream courtyard — dusty rose, light turquoise — then books. Soft, still quiet.
OWN-WORLD: Cream field, rose accent, turquoise secondary. Rubik. Rounded pills. Quiet vine lattice. Marks instead of emoji.
