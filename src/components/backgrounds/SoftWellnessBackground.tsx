    ...
    >
        ...
        style={{
          background: isDark
            ...
            : `radial-gradient(ellipse 74% 56% at 90% 6%, rgba(232, 245, 244, 0.9), transparent 56%),
               radial-gradient(ellipse 70% 54% at 6% 94%, rgba(247, 238, 241, 0.88), transparent 52%),
               radial-gradient(ellipse 50% 42% at 48% 50%, rgba(250, 247, 242, 0.4), transparent 72%)`,
        }}
      />
      ...
      <div
        className={`absolute -end-[16%] bottom-[4%] h-[min(46vw,420px)] w-[min(46vw,420px)] rounded-full blur-3xl ${
          isDark ? "bg-[rgba(184,80,112,0.16)]" : "bg-[rgba(232,196,207,0.4)]"
        } opacity-85`}
      />
